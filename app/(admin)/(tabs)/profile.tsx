...
import { LogOut, Settings, Shield, Database, Users, BarChart } from 'lucide-react-native';
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        <View style={styles.profileInfo}>
          ...
          <View style={styles.userInfo}>
            ...
            <Text style={styles.userRole}>{t('administrator')}</Text>
          </View>
        </View>
      </View>
      ...
      <View style={styles.menu}>
        <TouchableOpacity style={styles.menuItem}>
          ...
          <Text style={styles.menuText}>{t('manageUsers')}</Text>
        </TouchableOpacity>
        
        <TouchableOpacity style={styles.menuItem}>
          <Database size={20} color="#FFFFFF" />
          <Text style={styles.menuText}>System Database</Text>
        </TouchableOpacity>
